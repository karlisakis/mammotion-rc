/*!
 * nipplejs v0.10.1 — https://github.com/yoannmoinet/nipplejs
 * Copyright (c) 2015 Yoann Moinet
 * Released under the MIT License.
 *
 * Vendored locally (rather than loaded from a CDN) on purpose: the joystick is
 * the app's primary control, and a phone that is on the LAN but has no route to
 * the internet would otherwise load the page fine and then have no stick at
 * all.  See THIRD-PARTY-NOTICES.md.
 */
/**
 * Skipped minification because the original files appears to be already minified.
 * Original file: /npm/nipplejs@0.10.1/dist/nipplejs.js
 *
